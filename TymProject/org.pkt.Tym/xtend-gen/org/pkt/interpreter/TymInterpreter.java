...
public class TymInterpreter {
  ...
  protected Object _interpret(final Expression e) {
    ...
    if (!_matched) {
      if (e instanceof Plus) {
        ...
        if ((this._tymTypeComputer.isStringType(this._tymTypeComputer.typeFor(((Plus)e).getLeft())) || this._tymTypeComputer.isStringType(this._tymTypeComputer.typeFor(((Plus)e).getRight())))) {
    ...
    if (!_matched) {
      if (e instanceof Comparison) {
        _matched=true;
        boolean _xifexpression = false;
        boolean _isStringType = this._tymTypeComputer.isStringType(this._tymTypeComputer.typeFor(((Comparison)e).getLeft()));
        if (_isStringType) {
  ...
  protected Object _interpretEcho(final Expression e) {
    Object _switchResult = null;
    boolean _matched = false;
    if (e instanceof IntConstant) {
      _matched=true;
    ...
    if (!_matched) {
      if (e instanceof VariableRef) {
        _matched=true;
        _switchResult = ((VariableRef)e).getVariable().getName();
      }
    }
    return _switchResult;
  }
  ...
  protected Object _interpret(final AbstractElement e) {
    ...
    if (e instanceof Variable) {
      _matched=true;
      _switchResult = this.interpret(((Variable)e).getExpression());
    }
    return _switchResult;
  }
  ...
  public Object interpretEcho(final Expression e) {
    return _interpretEcho(e);
  }
}
